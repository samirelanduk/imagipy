...
The `GitHub issue
tracker <https://github.com/samirelanduk/imagipy/issues>`__ is the place
...
The first step is to fork the imagipy repository to your own GitHub
...
clone your new copy of imagipy to your local machine, and to do this
you simply enter ``clone https://github.com/YOUR_USERNAME/imagipy`` at
...
An ideal pull request for imagipy is one that either adds a function (or
...
If your pull request modifies large parts of imagipy, changes the way the
...
If a function doesn't have tests, the function doesn't work. imagipy has
